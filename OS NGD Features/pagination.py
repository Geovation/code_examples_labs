...
def run_paginated_requests():
    ...
    request_parameters = {"bbox": YOUR_BOUNDING_BOX,
                          "limit": request_limit, "offset": None}
    ...
    while next_link is None or next_link is True:
        ...
        os_response = requests.get(url=OS_NGD_URL, headers={
                                   'key': YOUR_OS_API_KEY}, params=request_parameters, timeout=10).json()
